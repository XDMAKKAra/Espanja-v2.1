...
// YTL grade from total points — official absolute thresholds (80/65/50/35/20/10).
// Same table used by lib/grading.js for all non-writing exercise types.
// Thresholds derived from YTL lyhyt oppimäärä pisterajat (3-year average, max 299):
// L≥92%, E≥84%, M≥73%, C≥60%, B≥48%, A≥39%, I<39%
