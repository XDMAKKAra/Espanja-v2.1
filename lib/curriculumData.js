...
/**
 * Saksan B3 curriculum (lyhyt oppimäärä).
 *
 * Tavoitetaso CEFR: A2.1 (LOPS 2021 B3 saksan virallinen tavoite).
 * Progressio A → E vastaa espanjan curriculumin tasomerkintöjä, mutta CEFR-tasot
 * ovat yhden askeleen alempana (esim. E-taso ≈ A2.2/B1.1 saksassa, ei B2).
 *
 * Lähde: pedagogy/saksa-RUBRIC.md + LOPS 2021 saksa B3 moduulit (SAB3OJ1–9).
 */
const DE_KURSSIT = [
  { key: "kurssi_1", title: "Kurssi 1 — Wer bin ich",             description: "Tervehdykset, persoona ja perhe; Präsens säännölliset, artikkelit Nominativissa.",                            level: "A", vocab_theme: "general vocabulary",     grammar_focus: ["present_regular", "articles_nominative"],                          lesson_count: 10, sort_order: 1 },
  { key: "kurssi_2", title: "Kurssi 2 — Alltag und Leben",         description: "Arki ja harrastukset; Präsens epäsäännölliset (sein/haben/sprechen), Akkusativ, modaaliverbit.",                level: "A", vocab_theme: "general vocabulary",     grammar_focus: ["present_irregular", "accusative_case", "modal_verbs"],             lesson_count: 10, sort_order: 2 },
  { key: "kurssi_3", title: "Kurssi 3 — Was habe ich gemacht",     description: "Matkustaminen ja kulkuvälineet; Perfekt haben/sein, partisiipin perfekti, V2-sääntö.",                          level: "B", vocab_theme: "travel and transport",   grammar_focus: ["perfekt", "past_participles", "v2_word_order"],                    lesson_count: 11, sort_order: 3 },
  { key: "kurssi_4", title: "Kurssi 4 — Damals und heute",         description: "Lapsuus ja luonto; Präteritum (kirjoitetussa kielessä), Dativ-prepositiot, sivulauseet weil/dass.",            level: "B", vocab_theme: "environment and nature", grammar_focus: ["praeteritum", "dative_prepositions", "subordinate_clauses_weil_dass"], lesson_count: 12, sort_order: 4 },
  { key: "kurssi_5", title: "Kurssi 5 — Zukunft und Träume",       description: "Työ ja teknologia; Futur I, sivulauseet wenn-konditionaali, V-loppu sivulauseessa.",                            level: "C", vocab_theme: "work and economy",       grammar_focus: ["futur", "subordinate_clauses_wenn", "verb_end_subordinate"],       lesson_count: 11, sort_order: 5 },
  { key: "kurssi_6", title: "Kurssi 6 — Probleme der Welt",        description: "Ympäristö ja yhteiskunta; Passiv (werden + Partizip II), Konjunktiv II kohteliaisuusmuodot.",                  level: "C", vocab_theme: "society and politics",   grammar_focus: ["passive_voice", "konjunktiv_ii_polite"],                           lesson_count: 12, sort_order: 6 },
  { key: "kurssi_7", title: "Kurssi 7 — Kultur und Gesellschaft",  description: "DACH-kulttuuri ja media; Konjunktiv II (wenn ich hätte), Genitiv perusteet, sivulauseet obwohl/damit.",        level: "M", vocab_theme: "culture and arts",       grammar_focus: ["konjunktiv_ii", "genitive_case", "subordinate_clauses_obwohl"],    lesson_count: 12, sort_order: 7 },
  { key: "kurssi_8", title: "Kurssi 8 — Bereit fürs Abitur",       description: "Kaikkien rakenteiden kertaus; Konjunktiv II syvemmin, indirekte Rede, YO-tyyppiset tehtävät.",                  level: "E", vocab_theme: "general vocabulary",     grammar_focus: ["konjunktiv_ii_advanced", "indirect_speech", "exam_review"],        lesson_count: 12, sort_order: 8 },
];

/**
 * Ranskan B3 curriculum (lyhyt oppimäärä).
 *
 * Tavoitetaso CEFR: A2 → B1.1 (LOPS 2021 B3-oppimäärän tavoite, ranskan
 * lyhyt oppimäärä yo-koe). Progressio A → E vastaa espanjan curriculumin
 * tasomerkintöjä; CEFR-kattona realistisesti B1 lyhyellä oppimäärällä.
 *
 * Lähde: pedagogy/ranska-RUBRIC.md + data/courses/fr/curriculum-spec.md +
 * LOPS 2021 ranska B3 moduulit (RAB31–RAB38).
 */
const FR_KURSSIT = [
  { key: "kurssi_1", title: "Kurssi 1 — Qui je suis",                description: "Tervehdykset, persoona ja perhe; présent säännölliset (-er), määräiset artikkelit le/la/les, aimer/préférer.",                level: "A", vocab_theme: "general vocabulary",     grammar_focus: ["present_regular", "definite_articles", "negation_ne_pas"],                lesson_count: 10, sort_order: 1 },
  { key: "kurssi_2", title: "Kurssi 2 — La vie quotidienne",         description: "Arki ja ruoka; présent epäsäännölliset (être/avoir/aller/faire), partitiivit du/de la/des, accord en genre/nombre.",      level: "A", vocab_theme: "general vocabulary",     grammar_focus: ["present_irregular", "partitive_articles", "gender_number_agreement"],      lesson_count: 10, sort_order: 2 },
  { key: "kurssi_3", title: "Kurssi 3 — Mes vacances",               description: "Matkustaminen ja muistot; passé composé avoir/être-jako, partisiipin accord, maille-prepositiot en/au/aux.",                level: "B", vocab_theme: "travel and transport",   grammar_focus: ["passe_compose", "etre_vs_avoir_aux", "country_prepositions"],              lesson_count: 11, sort_order: 3 },
  { key: "kurssi_4", title: "Kurssi 4 — Quand j'étais petit",        description: "Lapsuus ja luonto; imparfait ja passé composé vs imparfait — YO-klassikko, keskeytysrakenne.",                                 level: "B", vocab_theme: "environment and nature", grammar_focus: ["imparfait", "passe_compose_vs_imparfait"],                                 lesson_count: 12, sort_order: 4 },
  { key: "kurssi_5", title: "Kurssi 5 — Le futur et les rêves",      description: "Työ ja teknologia; futur simple säännölliset+epäsäännölliset, futur proche, conditionnel kohteliaisuusmuodot.",            level: "C", vocab_theme: "work and economy",       grammar_focus: ["futur_simple", "futur_proche", "conditionnel_present"],                    lesson_count: 11, sort_order: 5 },
  { key: "kurssi_6", title: "Kurssi 6 — Les problèmes du monde",     description: "Ympäristö ja yhteiskunta; subjonctif présent (il faut que, je veux que, bien que), mielipide-ilmaukset.",                    level: "C", vocab_theme: "society and politics",   grammar_focus: ["subjonctif_present"],                                                      lesson_count: 12, sort_order: 6 },
  { key: "kurssi_7", title: "Kurssi 7 — Culture et société",         description: "Kulttuuri ja taide; plus-que-parfait, subjonctif syvemmin, suhteelliset pronominit qui/que/dont/où.",                         level: "M", vocab_theme: "culture and arts",       grammar_focus: ["plus_que_parfait", "subjonctif_advanced", "relative_pronouns"],            lesson_count: 12, sort_order: 7 },
  { key: "kurssi_8", title: "Kurssi 8 — Préparation au bac",         description: "YO-koevalmiiksi; si-hypoteesilauseet (présent+futur / imparfait+conditionnel / plus-que-parfait+conditionnel passé).",       level: "E", vocab_theme: "general vocabulary",     grammar_focus: ["si_hypotheses", "conditionnel_passe", "exam_review"],                      lesson_count: 12, sort_order: 8 },
];

/**
 * Per-language curriculum registries.
 * - es: full Spanish curriculum (8 courses)
 * - de: full German B3 curriculum (8 courses, A2 target)
 * - fr: full French B3 curriculum (8 courses, A2→B1 target)
 */
export const LANG_CURRICULA = {
  es: ES_KURSSIT,
  de: DE_KURSSIT,
  fr: FR_KURSSIT,
};

// Back-compat alias — existing call sites import CURRICULUM_KURSSIT directly.
export const CURRICULUM_KURSSIT = LANG_CURRICULA.es;
