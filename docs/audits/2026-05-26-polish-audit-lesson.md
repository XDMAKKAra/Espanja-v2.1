# L-V322 lesson + exam polish audit · 2026-05-26

**Base:** https://espanja-v2-1.vercel.app
**Account:** testpro123@gmail.com (Pro test)
**States captured:** 6 (curriculum, lesson-runner active, lesson mid, vocab mode, exam start, exam running) × 2 viewports = 12 scans
**Screenshots:** `screenshots/polish-audit-lesson-2026-05-26/`
**Full data:** `docs/audits/2026-05-26-polish-audit-lesson.json`
