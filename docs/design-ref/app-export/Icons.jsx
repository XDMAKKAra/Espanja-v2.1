// Icons — React-native Lucide SVGs. Renders a real <svg> inside React so
// reconciliation never fights a mutated DOM (the createIcons() crash). Size
// comes from CSS (.lucide + context rules) unless a style override is passed.
window.LUCIDE_PATHS = {
...
function Icon({ name, className = 'lucide', style }) {
  return (
    <svg
      className={className}
      style={style}
