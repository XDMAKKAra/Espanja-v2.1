import{b as m}from"./app-chunk-UF63D4UW.js";import"./app-chunk-ECRDZOTG.js";import{b as d}from"./app-chunk-PXMVMW5B.js";function r(s){return String(s??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function $(s){return{vocab:"Sanasto",grammar:"Kielioppi",mixed:"Yhdistelm\xE4",reading:"Luetun ymm\xE4rt\xE4minen",writing:"Kirjoittaminen",exam:"Kertaustesti"}[s]||"Oppitunti"}function h(s,e,a,o){let t=s.sortOrder||0,p=!!s.completed,n=$(s.type),l=s.focus||s.title||`Oppitunti ${t}`,c=["op-row","is-clickable",p?"is-done":t===b?"is-progress":""].filter(Boolean).join(" "),i=p?"Suoritettu":"Aloita \u2192",f=Number(s.estimated_minutes)||14,_=`#/oppitunti/${e}/${encodeURIComponent(a)}/${t}`;return`
    <li class="op-row-li">
...
//# sourceMappingURL=app-courseDetail-TUJCM24Q.js.map
