import{a as ct}from"./app-chunk-XYSTN2TU.js";import{b}from"./app-chunk-EVWRWXV5.js";import{b as D}from"./app-chunk-AE7C6F2Z.js";import{a as I,c as K,d as V,e as A,j as E}from"./app-chunk-T52YLBP4.js";import{b as ot}from"./app-chunk-PXMVMW5B.js";function ee(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function $(t){let e=ee(t);return e=e.replace(/`([^`]+)`/g,'<code class="dk__teoria-code">$1</code>'),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*\n]+)\*/g,"<em>$1</em>"),e=e.replace(/(^|\s)_([^_\n]+)_(?=\s|[.,;:!?]|$)/g,"$1<em>$2</em>"),e}function dt(t){return/^\s*\|?\s*:?-{2,}:?(\s*\|\s*:?-{2,}:?\s*)+\|?\s*$/.test(t)}function lt(t){return t.trim().replace(/^\|/,"").replace(/\|$/,"").split("|").map(s=>s.trim())}function se(t,e){let s=lt(t),n=e.map(lt),a=s.map(o=>`<th>${$(o)}</th>`).join(""),i=n.map(o=>`<tr>${o.map(c=>`<td>${$(c)}</td>`).join("")}</tr>`).join("");return`<div class="dk__bilingual${s.length===2?" dk__bilingual--2col":""}"><table><thead><tr>${a}</tr></thead><tbody>${i}</tbody></table></div>`}function ne(t){return`
...
//# sourceMappingURL=app-digikirja-LQFOULFI.js.map
