import{a as u,b as d}from"./app-chunk-7KFQ2POU.js";import{a as m,d as h}from"./app-chunk-MIWMNCCI.js";import"./app-chunk-M4LELO7W.js";import{b as c}from"./app-chunk-PXMVMW5B.js";function t(e){return String(e??"").replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a])}function v(){let e=/lang=([a-z]{2})/i.exec(location.hash||"");if(e)return e[1].toLowerCase();try{return localStorage.getItem("puheo:lang")||"es"}catch{return"es"}}function $(e,a,i){let o=!!e.kertausPassed,r=!e.isUnlocked,s=e.lessonsCompleted||0,l=e.lessonCount||10,n=Math.min(100,Math.round(s/l*100)),p=o?"Suoritettu":r?"Avautuu vuorollaan":s>0?`${s} / ${l} oppituntia`:"Aloita \u2192",f=["op-row",o?"is-done":"",r?"is-locked":"is-clickable",s>0&&!o?"is-progress":""].filter(Boolean).join(" "),b=r?"#":`#/oppimispolku/${i}/${encodeURIComponent(e.key)}`;return`
    <li class="op-row-li">
    ...
    </li>`}function k(e,a){let i=a.filter(s=>s.kertausPassed).length,o=a.length;return`
    ...
    </div>`}async function y(e){c("screen-oppimispolku-index");let a=document.getElementById("op-root");if(!a)return;let i=e||v();a.innerHTML='<div class="op-loading" role="status" aria-label="Ladataan kursseja"><span class="sr-only">Ladataan kursseja\u2026</span></div>';let o=await m(i);if(o.length===0){_(a,"Kursseja ei viel\xE4 julkaistu t\xE4lle kielelle.");return}a.innerHTML=k(i,o),a.querySelectorAll(".op-row.is-locked").forEach(r=>{r.addEventListener("click",s=>s.preventDefault())}),a.querySelectorAll(".op-row.is-clickable").forEach(r=>{let s=r.dataset.kurssi;s&&d(r,()=>{u("courseDetail",()=>import("./app-courseDetail-KDWHQCMH.js")),h(i,s)})})}function L(e){return/^#\/oppimispolku(\?|$)/.test(e||"")?(y(),!0):!1}export{y as loadOppimispolkuIndex,L as tryRouteOppimispolkuIndex};
//# sourceMappingURL=app-oppimispolkuIndex-AM47D27W.js.map
