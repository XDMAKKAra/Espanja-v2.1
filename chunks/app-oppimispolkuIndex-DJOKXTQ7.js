import{a as k,b as v}from"./app-chunk-7KFQ2POU.js";import{a as f,d as $}from"./app-chunk-MBUTCT5U.js";import{c as u}from"./app-chunk-HBIQAVI5.js";import"./app-chunk-NNOC372C.js";import{b as h}from"./app-chunk-A6LS4W5A.js";var w={"chevron-right":'<path d="m9 18 6-6-6-6"/>',lock:'<rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',"circle-check":'<circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/>'};function p(s,r=""){return`<svg class="lucide" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" ${r}>${w[s]||""}</svg>`}var g=`
  <svg class="lp-illu" width="186" height="92" viewBox="0 0 186 92" fill="none" aria-hidden="true">
    ...
    </div>`}async function x(s){h("screen-oppimispolku-index");let r=document.getElementById("op-root");if(!r)return;let a=s||y();r.innerHTML='<div class="op-loading" role="status" aria-label="Ladataan kursseja"><span class="sr-only">Ladataan kursseja\u2026</span></div>';let o=await f(a);if(o.length===0){C(r,"Kursseja ei viel\xE4 julkaistu t\xE4lle kielelle.");return}r.innerHTML=L(a,o),r.querySelectorAll("a.lp-row").forEach(n=>{let e=n.dataset.kurssi;e&&v(n,()=>{k("courseDetail",()=>import("./app-courseDetail-OT54TCYI.js")),$(a,e)})})}function I(s){return/^#\/oppimispolku(\?|$)/.test(s||"")?(x(),!0):!1}export{x as loadOppimispolkuIndex,I as tryRouteOppimispolkuIndex};
//# sourceMappingURL=app-oppimispolkuIndex-DJOKXTQ7.js.map
