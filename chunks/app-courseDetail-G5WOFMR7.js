import{b as m}from"./app-chunk-EBUAEU6T.js";import"./app-chunk-NZWTLFMY.js";import{b as d}from"./app-chunk-3WC2U67L.js";function r(e){return String(e??"").replace(/[&<>"']/g,s=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[s])}function $(e){return{vocab:"Sanasto",grammar:"Kielioppi",mixed:"Yhdistelm\xE4",reading:"Luetun ymm\xE4rt\xE4minen",writing:"Kirjoittaminen",exam:"Kertaustesti"}[e]||"Oppitunti"}function h(e,s,a,o){let t=e.sortOrder||0,p=!!e.completed,i=$(e.type),l=e.focus||e.title||`Oppitunti ${t}`,u=["op-row","is-clickable",p?"is-done":t===b?"is-progress":""].filter(Boolean).join(" "),n=p?"Suoritettu":"Aloita \u2192",f=Number(e.estimated_minutes)||14,_=`#/oppitunti/${s}/${encodeURIComponent(a)}/${t}`;return`
...
//# sourceMappingURL=app-courseDetail-G5WOFMR7.js.map
